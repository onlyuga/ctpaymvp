package com.ifs.wiget.bottombar;
...
import com.ifs.wiget.R;
import com.ifs.wiget.bottombar.scrollsweetness.BottomNavigationBehavior;
...
public class BottomBar extends FrameLayout implements View.OnClickListener, View.OnLongClickListener {
    ...
    public void selectTabAtPosition(int position) {
        ...
        unselectTab(mItemContainer.findViewWithTag(TAG_BOTTOM_BAR_VIEW_ACTIVE), true);
        selectTab(mItemContainer.getChildAt(position), true);
    ...
    public void selectTab(View tab, boolean animate) {
